...
const ANTHROPIC_CHAT_MODELS = ['claude-sonnet-4-5', 'claude-sonnet-4-6', 'claude-opus-4-7', 'claude-opus-4-8', 'claude-haiku-4-5'] as const
const ANTHROPIC_OPENROUTER_CHAT_MODELS = ['claude-sonnet-4.5', 'claude-sonnet-4.6', 'claude-opus-4.7', 'claude-opus-4.8', 'claude-haiku-4.5'] as const
...
export const PLUGR_SPECIALIST_AGENT_MODEL = {

...
const ANTHROPIC_CHAT_MODELS = ['claude-sonnet-4-5', 'claude-sonnet-4-6', 'claude-opus-4-7', 'claude-haiku-4-5'] as const
const ANTHROPIC_OPENROUTER_CHAT_MODELS = ['claude-sonnet-4.5', 'claude-sonnet-4.6', 'claude-opus-4.7', 'claude-haiku-4.5'] as const
...
export const ACTIVEPIECES_CHAT_TIERS = [
    ...
    { id: 'smart', label: 'Expert', modelId: 'anthropic/claude-sonnet-4.5', thinkingBudget: 10_000 },

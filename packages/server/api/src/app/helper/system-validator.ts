...
const systemPropValidators: {
    ...
    [AppSystemProp.API_RATE_LIMIT_LOGIN_MAX]: numberValidator,
    [AppSystemProp.API_RATE_LIMIT_LOGIN_WINDOW]: stringValidator,
    [AppSystemProp.API_RATE_LIMIT_RESET_PWD_MAX]: numberValidator,
    [AppSystemProp.API_RATE_LIMIT_RESET_PWD_WINDOW]: stringValidator,
    [AppSystemProp.API_RATE_LIMIT_API_MAX]: numberValidator,
    [AppSystemProp.API_RATE_LIMIT_API_WINDOW]: stringValidator,
    [AppSystemProp.API_RATE_LIMIT_WEBHOOK_MAX]: numberValidator,
    [AppSystemProp.API_RATE_LIMIT_WEBHOOK_WINDOW]: stringValidator,
    ...
    [AppSystemProp.FLUTTERWAVE_API_BASE_URL]: stringValidator,
    [AppSystemProp.FLUTTERWAVE_CHECKOUT_BASE_URL]: stringValidator,
    [AppSystemProp.FLUTTERWAVE_CLIENT_ID]: stringValidator,
    [AppSystemProp.FLUTTERWAVE_CLIENT_SECRET]: stringValidator,
    [AppSystemProp.FLUTTERWAVE_CURRENCY]: stringValidator,
    [AppSystemProp.FLUTTERWAVE_SECRET_HASH]: stringValidator,
    [AppSystemProp.FLUTTERWAVE_SECRET_KEY]: stringValidator,

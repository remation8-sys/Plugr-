...
const systemPropDefaultValues: Partial<Record<SystemProp, string>> = {
    ...
    [AppSystemProp.API_RATE_LIMIT_LOGIN_MAX]: '5',
    [AppSystemProp.API_RATE_LIMIT_LOGIN_WINDOW]: '1 minute',
    [AppSystemProp.API_RATE_LIMIT_RESET_PWD_MAX]: '3',
    [AppSystemProp.API_RATE_LIMIT_RESET_PWD_WINDOW]: '3600',
    [AppSystemProp.API_RATE_LIMIT_API_MAX]: '100',
    [AppSystemProp.API_RATE_LIMIT_API_WINDOW]: '60',
    [AppSystemProp.API_RATE_LIMIT_WEBHOOK_MAX]: '1000',
    [AppSystemProp.API_RATE_LIMIT_WEBHOOK_WINDOW]: '1 hour',
